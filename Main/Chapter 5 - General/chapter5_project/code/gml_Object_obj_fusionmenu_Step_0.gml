if (init == 0)
{
    ...
    if (type == 1)
    {
        ...
        scr_fusion_queue(4);
        scr_fusion_queue(5);
        scr_fusion_queue(200);
        scr_fusion_queue(201);
        scr_fusion_queue(6);
        scr_fusion_queue(7);
        scr_fusion_queue(8);
        scr_fusion_queue(9);
        ...
        scr_fusion_queue(12);
        scr_fusion_queue(13);
        scr_fusion_queue(202);
        scr_fusion_queue(203);
        scr_fusion_queue(204);
        scr_fusion_queue(205);
        ...
        for (j = 0; j <= menuMaximumID[0]; j++)
        {
            ...
            optionCommentCColor[0][j] = fusionCanMake[j] ? c_white : c_gray;
    ...
    if (type == 2)
    {
        ...
        dojoEncounter[3] = 0;
        dojoEncounter[4] = 0;
        dojoName[0] = stringsetloc("Trashy Trio", "obj_fusionmenu_slash_Step_0_gml_150_0_b");
        dojoName[1] = stringsetloc("-------------", "obj_fusionmenu_slash_Step_0_gml_151_0");
        dojoName[2] = stringsetloc("-------------", "obj_fusionmenu_slash_Step_0_gml_151_0");
        dojoName[3] = stringsetloc("-------------", "obj_fusionmenu_slash_Step_0_gml_152_0");
        dojoName[4] = stringsetloc("-------------", "obj_fusionmenu_slash_Step_0_gml_153_0");
        dojoTopComment[0] = stringsetloc("We've been neglected long enough!#It's time for a new most popular trio in town!", "obj_fusionmenu_slash_Step_0_gml_156_0");
        dojoTopComment[1] = stringsetloc(" ", "obj_fusionmenu_slash_Step_0_gml_157_0_b");
        dojoTopComment[2] = stringsetloc(" ", "obj_fusionmenu_slash_Step_0_gml_157_0_b");
        dojoTopComment[3] = stringsetloc(" ", "obj_fusionmenu_slash_Step_0_gml_158_0_b");
        dojoTopComment[4] = stringsetloc(" ", "obj_fusionmenu_slash_Step_0_gml_159_0_b");
        dojoPrizeName[0] = stringsetloc("None", "obj_fusionmenu_slash_Step_0_gml_163_0_b");
        dojoPrizeName[1] = stringsetloc("---", "obj_fusionmenu_slash_Step_0_gml_164_0");
        dojoPrizeName[2] = stringsetloc("---", "obj_fusionmenu_slash_Step_0_gml_164_0");
        dojoPrizeName[3] = stringsetloc("---", "obj_fusionmenu_slash_Step_0_gml_165_0");
        dojoPrizeName[4] = stringsetloc("---", "obj_fusionmenu_slash_Step_0_gml_166_0");
        dojoPrizeValue[0] = 0;
        dojoPrizeValue[1] = 0;
        dojoPrizeValue[2] = 0;
        dojoPrizeValue[3] = 0;
