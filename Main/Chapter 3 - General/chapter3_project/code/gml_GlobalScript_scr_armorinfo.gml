function scr_armorinfo(arg0)
{
    ...
    switch (arg0)
    {
        ...
        case 3:
            ...
            armordesctemp = stringsetloc("A cute hair ribbon. Increases the range#at which bullets raise tension.", "scr_armorinfo_slash_scr_armorinfo_gml_71_0");
        ...
        case 15:
            ...
            amessage2temp = stringset(" I guess it's ALMOST cool.");
            amessage3temp = stringset("Intense...!");
            amessage4temp = stringset("... do I put it in my hair?");
            armorattemp = 0;
            armordftemp = 2;
            armormagtemp = 0;
            armorboltstemp = 0;
