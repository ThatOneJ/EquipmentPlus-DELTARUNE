...
if (global.chapter == 3 && (room == room_board_1 || room == room_board_2 || room == room_board_3) && !i_ex(obj_elnina_enemy) && !i_ex(obj_rouxls_ch3_enemy) && global.encounterno != 111 && global.flag[1022] == 0)
