...
var _treasure = instance_create(250, 268, obj_treasure_room);
_treasure.depth = 900000;
var _treasure_shadow = instance_create(0, 0, obj_dw_ranking_t_shadow_char);

with (_treasure_shadow)
    init(_treasure, 0, 0.4);
